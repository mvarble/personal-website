...
In the seminal paper of Duffie, et al. [[1]](https://projecteuclid.org/journals/annals-of-applied-probability/volume-13/issue-3/Affine-processes-and-applications-in-finance/10.1214/aoap/1060202833.full), [[2]](https://web.stanford.edu/~duffie/affine.pdf), the class of *affine processes* is extensively explored and motivated with examples of applications to finance.
...
Here, we are adopting the slightly more general time-inhomogeneous case discussed in [[3]](https://www.sciencedirect.com/science/article/pii/S0304414904001838).
There are some great papers (for instance, [[4]](https://www.research-collection.ethz.ch/handle/20.500.11850/46416), [[5]](https://projecteuclid.org/journals/annals-of-applied-probability/volume-25/issue-2/Exponential-moments-of-affine-processes/10.1214/14-AAP1009.full), [[6]](https://arxiv.org/abs/1811.00122)) that subsequently study these objects&mdash;be it generalizing results, weakening hypotheses, focusing on specific cases, or studying related statistical procedures.
...
<Proof>
  ...
  We now evaluate the $M_t = f(t, X_t)$ according to It&ocirc;'s formula.
  $$\begin{aligned}
