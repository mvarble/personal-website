...
A classic result of L&eacute;vy (see <Cite bibKey="kallenberg2002">Kallenberg</Cite> or [Wikipedia](https://en.wikipedia.org/wiki/L%C3%A9vy%27s_continuity_theorem)) dictates that such a weak convergence is determined by that of pointwise convergence of the characteristic functions.
...
The keen eye will recognize that the final expression above is the characteristic function of a [Gamma distribution](https://en.wikipedia.org/wiki/Gamma_distribution) of shape $2ab/\sigma^2$ and rate $2a/\sigma^2$.
...
Below, we write small [Julia](https://julialang.org/) script which invokes a simple [Euler-Maruyama](https://en.wikipedia.org/wiki/Euler%E2%80%93Maruyama_method) scheme to simulate $100$ (biased) samples of marginals
