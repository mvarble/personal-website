...
A classic result of L&eacute;vy [[1]](https://en.wikipedia.org/wiki/L%C3%A9vy%27s_continuity_theorem), [[2]](https://doi.org/10.1007/978-1-4757-4015-8) dictates that such a weak convergence is determined by that of pointwise convergence of the characteristic functions.
