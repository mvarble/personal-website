...
```shell
mkdir ~/development/my-new-script-directory
cd ~/development/my-new-script-directory
```
...
In other words, each time I return back to developing, I go to the `~/development/SomePackage.jl/sandbox` directory in a shell and run the following,
