...
<p>{ String.raw`
  For instance, if we have to roll $5$ dice, the unpredictable outcome of each die could be encoded with functions $X_1, \ldots, X_5: \Omega \rightarrow \{1, \ldots, 6\}$ defined on a probability space $(\Omega, \Sigma, \rmP)$.
